...
| M2-17 | **Nährwerte-Import (GL-08-Quelle!)** | Import `nutritional` (127.644 Zeilen: energy_kcal/kj, protein, fat, carbs, … + bls_key) → `foodalchemist_item_nutritionals` — Blocker für M3-04-Nährwert-Ø + Panel-Sektion M3-05, analog M2-09/M2-15 | Screen-1-Abgleich (13_REFERENZ); GL-08 | Row-Gate; LA zeigt Nährwerte je 100 g | ☐ |
...
| M3-07 | Panel: LA-Sektion | Verknüpfte LAs (Lead-Stern, Preis, qty?-Warnung), Aktionen: Lead setzen, **LA sperren** (Override-UI), lösen, verknüpfen. **+Nachtrag (Screen-2-Abgleich):** Lead-★-Spalte auch in der Artikel-Tabelle des Lieferanten-Browsers | P-1; M3-06 | „LA A sperren → B wird Lead" im Browser beweisbar | ☐ |
