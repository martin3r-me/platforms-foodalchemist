...
- [ ] **Skizzen-Integration** — Ideen/Skizzen als Kaskaden-Eingang (bisher deferred)
  ...
  - [x] **Teil 2a — Lineage (Skizze ↔ Lauf):** der Gericht-Go aus einer übertragenen Skizze stempelt den Kaskaden-Lauf auf die Ursprungs-Skizze zurück (`origin_dish_idea_id`) — Voraussetzung für die Status-Rückkopplung auf die Karte.
    ...
    - [ ] **Teil 2b — Status auf die Karte:** den Stand des verknüpften Laufs (läuft/prüfen/fertig/fehlgeschlagen) auf der Skizzen-Karte im Divergenz-Board zeigen (nutzt `origin_dish_idea_id` aus 2a) + Kurz-Lineage.
    - [ ] **Teil 3:** KI-Divergenz-Skizzen als Batch-Kaskaden-Eingang.
