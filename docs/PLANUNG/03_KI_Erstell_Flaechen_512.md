...
- [ ] **(L8b-2, offen)** Optional als Generator-Input: **Ziel-VK/Zielmarge als Pill** („Gericht für 8,50 € VK") → fließt als Constraint in den Prompt + wird nach der Kalkulation ehrlich gegen das Ergebnis gehalten (Brücke zu R2.4-Solver-Denke, KEIN Solver in v1) — L8b
