...
| **S4b-2** | Tranche C · Anker-Graph | S | `konzept_dramaturgie` (info) über `PairingService::menuCohesion` — andere Mechanik, greift auch ohne Gerüst |
| **S4c** | Tranche D | M | Foodbook-Signale; `foodbook_kapitel_ohne_text` **erst nach L2** scharfstellen |
