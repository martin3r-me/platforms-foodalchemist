...
| **S3b-2** | Tranche P · Punkte 8, 4, 5 | S–M | Policy-Regler aus E2 im Panel · Sparkline aus `SignalTrendService::serie` · Ursachen-Kette nach unten (`br_ek_teil` → unbepreiste GPs → fehlende Lead-LAs; Regelwerk-Signale → verletztes §). **Punkt 6 (Historie) nicht baubar** ohne Migration → V-009 |
