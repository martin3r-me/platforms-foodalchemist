...
| **S3b-3** | Tranche P · Punkt 5 | S–M | Ursachen-Kette nach unten (`br_ek_teil` → unbepreiste GPs → fehlende Lead-LAs; Regelwerk-Signale → Deep-Link auf das verletzte §). **Punkt 6 (Historie) nicht baubar** ohne Migration → V-009 |
