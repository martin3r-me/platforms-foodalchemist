...
| A-03 | Cross-Tenant-Funde schließen | alle P0/P1-Funde aus Audit 23 behoben und regression-getestet | teilweise — **alle 10 P0 aus Audit 23 geschlossen** (Paket R, Branch `fix/paket-r-rezepte-gerichte`, bis `4b09b11`) + ein Teil der P1 (042/043/048/022/024/014/015/040/025). Offene P1: Pagination/Skalierung (016/033/035/038), Dashboard-Zähler (004–008), Deep-Links/Struktur (051/055–059). Regressionsschutz je Fund als `*TenantTest`/`*VertragTest` |
| A-04 | Adversarial Tenant Suite | Global-, Parent-, eigenes Team- und Fremdteam-Fall je Aktion | teilweise — je P0-Bereich eine adversariale Testdatei (own/parent/global/sibling), `TeamScope::referenz` mit Vererbungs-Wächter; eine EINHEITLICHE Aktionsmatrix über alle öffentlichen Methoden (A-01) steht noch aus. Spec 32 hat seine eigenen neuen Schreibaktionen adversarial abgedeckt (`ControllingTenantTest`) und dabei eine Cross-Tenant-Lücke in der Import-Ablage gefunden — ein Beleg dafür, dass die Lücken dort sitzen, wo kein Eloquent-Objekt beteiligt ist |
