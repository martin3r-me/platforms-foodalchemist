...
| A-04 | Adversarial Tenant Suite | Global-, Parent-, eigenes Team- und Fremdteam-Fall je Aktion | teilweise — je P0-Bereich eine adversariale Testdatei (own/parent/global/sibling), `TeamScope::referenz` mit Vererbungs-Wächter; eine EINHEITLICHE Aktionsmatrix über alle öffentlichen Methoden (A-01) steht noch aus |
