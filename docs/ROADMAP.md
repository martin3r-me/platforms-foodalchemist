...
- **Offen (optional):** VK-„Teller-Profil" (`sensorik_komposition.blade.php`) noch Balken (kein Radar) — die Empfehlungen sind dort jetzt aber wieder da; Radar-Umstellung bleibt Folge-Kandidat für Konsistenz.
