...
- 2026-07-16 (#507 E0–E4 + #508): **RAG-/Semantik-Retrieval-Layer lokal gebaut (provider-agnostisch).** Kern von #507 — die fehlende Retrieval-Hälfte über die GP-/Rezept-Pools; Augmentation stand bereits.
  ...
  - **26 neue Tests, volle Suite 728/729 grün, null Regression** (deterministische Match-Entscheidung + 84 Goldens byte-identisch). **Offen (online per MCP):** E5 OpenAI-Floor-Eichung am Golden-Set (Key nötig), E6 demo-Backfill `foodalchemist:embed --pool=all` + Flag `FOODALCHEMIST_SEMANTIC_SEARCH=true` (Martin). Memory `project_fa_507_semantic_search.md`.
