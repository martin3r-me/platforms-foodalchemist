...
### R6.11 Hypothesen- & Widerspruchs-Modus (R&D) · Größe M · Hängt an: Q4 + Pairing-Graph · **S1–S3 ✅ GEBAUT 2026-07-19**
...
- [x] Als MCP-Tool (`knowledge.HYPOTHESIZE` read-only + `lab_notes.POST` write), read-only bis Draft (S1/S3 ✅)
