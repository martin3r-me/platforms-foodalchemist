...
- **Offen:** Live-Klickstrecke demo (Martin-Deploy); **S2 = Kern (persistente Bestellschiene `orders`/`order_lines` + OrderService + „Bedarf übernehmen"-UI, E1/E2/E9/E10/E11)** → S3 (PDF/CSV/mailto + `orders.*` MCP).
