...
**UX-Politur (`—`):** Menü-Vorschau (Kundensicht, ganzes Foodbook) ist jetzt ein **eigener Tab „🍽 Vorschau"** statt eines einklappbaren Balkens unter allen Tabs — konsistent mit „ein Tab = eine Fläche" (Input-Tabs Briefing/Planung/Kreativ/Trend/Branding + Output-Tab Vorschau). Pest 33/33 (Cockpit-rendernde Suiten).
