...
| **12_ROADMAP (fein-granulare Arbeits-Pakete M0–M8, Einstellungen bis KI-Engine — DER Abarbeitungs-Fahrplan)** | ✅ lebt (Status-Spalten pflegen!) — **M0 KOMPLETT ☑ (2026-06-11)**: Tenancy+Tests (M0-01…06), UI-Bausteine master-detail/modal/ki-header/tri-state/chips + Dichte-Maps (M0-07…12), KPI-Leiste (M0-13), KI-Gateway-Basis (M0-14). **M1 KOMPLETT ☑ (2026-06-11)**: /einstellungen-Gerüst + Curate-Gate (M1-01/08), Einheiten (M1-02), WG+Sub-Kat (M1-03), Rezept-Taxonomie importiert 30 HG/186 Kat (M1-04), Lead-LA-Strategie+Resolver (M1-05), Stamm-Matrix importiert 134 (M1-06), Kalk-Defaults (M1-07). **M2 BIS M2-12 ☑ (2026-06-11)**: Lieferanten-Browser /lieferanten (P-7-Zähler, globale Suche, 17.879 BOS-Artikel flüssig), PriceService (GL-11, GT-1 real), LA-Editor-Modal (4 Sektionen + Allergen-Tri-State), Allergen-Import 139.012, Artikel-CRUD (Kind-eigene), Anomalien-Report (1.041 echte Treffer). **OFFEN: Abnahme M2-13 durch Dominique persönlich** | Post-Slice (2026-06-11) |
