...
| **15_MASTERPLAN_VISION (Concepter→Vollausbau, M10–M16)** | ✅ lebt — Gates entschieden; **M10 + M10p + M10c Concepter GEBAUT** (Schema+Services+UI; Concept person-unabhängig, Kategorie-Baum, Allergen-Rollup; Suite 418/418); §9 Feature-Katalog je Modul; nächster Schritt M11 Foodbook | 2026-06-13 |
