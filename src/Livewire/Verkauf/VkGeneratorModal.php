...
class VkGeneratorModal extends Component
{
    ...
    {
        $this->reset('fehler', 'ergebnis', 'description', 'planningSessionId', 'zielVk', 'laeuft', 'runId', 'anreicherung', 'hinweis', 'fortschritt', 'hardstopMeldung', 'hardstopOffenIndex', 'freigegeben');
