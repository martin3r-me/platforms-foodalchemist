...
it('Workstream W: Routing-Zeile recipe.ueberarbeiten→regelwerk existiert — als discovery', function () {
    ...
    $zeile = DB::table('foodalchemist_knowledge_routings')
        ->where('feature', 'recipe.ueberarbeiten')->where('category', 'regelwerk')
