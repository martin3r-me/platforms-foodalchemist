...
it('persistiert alle nachgezogenen Felder inkl. Vorbestellzeit', function () {
    ...
    $item = FoodAlchemistSupplierItem::create([
        ...
        'additional_text' => 'Fass-Ware', 'vat' => 7.0, 'origin_country' => 'Deutschland',
        'organic_control_number' => 'DE-ÖKO-001', 'is_halal' => true, 'is_gmo_free' => true,
        'is_preorder' => true, 'preorder_days' => 89, 'ingredients_supplier' => 'Weißkohl, Salz',
    ]);
    ...
    expect($frisch->is_preorder)->toBeTrue()
        ...
        ->and($frisch->ingredients_supplier)->toBe('Weißkohl, Salz')
        ->and($frisch->additional_text)->toBe('Fass-Ware');
});
