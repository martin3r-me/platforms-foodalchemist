...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('foodalchemist_supplier_item_structures', function (Blueprint $table) {
            ...
            $table->decimal('flavor_ingredients_konfidenz', 4, 3)->nullable();
            $table->string('processing')->nullable();
            $table->decimal('processing_konfidenz', 4, 3)->nullable();
            ...
            $table->string('commodity_group_vorschlag')->nullable();
            $table->decimal('commodity_group_konfidenz', 4, 3)->nullable();
