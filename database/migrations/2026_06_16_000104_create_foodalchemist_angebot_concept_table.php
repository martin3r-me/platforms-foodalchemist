 ...
 * offer_id) bestehende STANDARDISIERTE Katalog-Concepts REFERENZIEREN (ohne sie
...
return new class extends Migration
{
    ...
    {
        Schema::create('foodalchemist_offer_concept', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['offer_id', 'concept_id']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('foodalchemist_offer_concept');
    }
};
