 ...
 *
 * Entscheide (Dominique 2026-06-13, Doc 15 §5): Rollen-Vokabular frei (role als
...
return new class extends Migration
{
    ...
    {
        // Freies Rollen-Vokabular (Autocomplete + Pflege; role wird als String
        // an Slot/Baustein gehalten, daher kein harter FK — „frei", D-CON-2).
        Schema::create('foodalchemist_vocab_roles', function (Blueprint $table) {
            $table->id();
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('foodalchemist_vocab_roles');
    }
};
