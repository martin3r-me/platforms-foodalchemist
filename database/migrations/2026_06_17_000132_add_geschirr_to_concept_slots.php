 ...
 * Hier dockt das Geschirr an: tableware_item_id (Haupt) + tableware_alt_item_id (Alternative,
...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('foodalchemist_concept_slots', function (Blueprint $table) {
            if (! Schema::hasColumn('foodalchemist_concept_slots', 'tableware_item_id')) {
                $table->unsignedBigInteger('tableware_item_id')->nullable()->index();
            }
            if (! Schema::hasColumn('foodalchemist_concept_slots', 'tableware_alt_item_id')) {
