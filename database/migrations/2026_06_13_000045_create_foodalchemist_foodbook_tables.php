...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('foodalchemist_foodbook_kapitel', function (Blueprint $table) {
            $table->id();
            $table->uuid('uuid')->unique();
            $table->unsignedBigInteger('team_id')->nullable()->index();
            $table->foreignId('foodbook_id')->constrained('foodalchemist_foodbooks')->cascadeOnDelete();
            $table->foreignId('parent_id')->nullable()->constrained('foodalchemist_foodbook_kapitel')->nullOnDelete();
        ...
        Schema::create('foodalchemist_foodbook_blocks', function (Blueprint $table) {
            ...
            $table->uuid('uuid')->unique();
            $table->unsignedBigInteger('team_id')->nullable()->index();
            $table->foreignId('kapitel_id')->constrained('foodalchemist_foodbook_kapitel')->cascadeOnDelete();
            $table->integer('position')->default(0);
            ...
            $table->string('bezeichnung')->nullable();                // intern
            ...
            $table->decimal('menge', 12, 3)->nullable();
            ...
            $table->string('header_quelle', 16)->nullable();          // KI-Lineage (GL-07)
            $table->timestamps();
            $table->softDeletes();
        });
    }
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('foodalchemist_foodbook_kapitel');
