 ...
 * gps.piece_default_g (T1 Zeile 4); KEINE Namens-Tabelle (GL-02 A-7).
 */
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('foodalchemist_gp_count_unit_defaults', function (Blueprint $table) {
            ...
            $table->foreignId('unit_vocab_id')->constrained('foodalchemist_vocab_units')->cascadeOnDelete();
            ...
            $table->unique(['gp_id', 'unit_vocab_id'], 'fa_gp_count_defaults_gp_einheit_unique');
        });
    }
