...
<div class="space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="{{ $card }} p-5 space-y-3" data-kalk-mwst>
            <h3 class="font-medium tracking-tight text-gray-900">MwSt-Defaults</h3>
            <div class="flex items-center gap-3"><span class="w-32 text-xs text-gray-600">Regulär</span>
                <input type="text" wire:model="mwst.regulaer" class="{{ $input }} !w-24" /> <span class="text-[11px] text-gray-500">%</span></div>
            <div class="flex items-center gap-3"><span class="w-32 text-xs text-gray-600">Ermäßigt</span>
                <input type="text" wire:model="mwst.ermaessigt" class="{{ $input }} !w-24" /> <span class="text-[11px] text-gray-500">%</span></div>
            <div class="flex items-center gap-3"><span class="w-32 text-xs text-gray-600">Default-Satz</span>
        ...
        <div class="{{ $card }} p-5 space-y-3" data-kalk-rundung>
            <h3 class="font-medium tracking-tight text-gray-900">Rundungsregeln</h3>
            <div class="flex items-center gap-3"><span class="w-40 text-xs text-gray-600">Nachkommastellen</span>
                <input type="number" min="0" max="4" wire:model="rundung.nachkommastellen" class="{{ $input }} !w-20" /></div>
            <div class="flex items-center gap-3"><span class="w-40 text-xs text-gray-600">Modus</span>
