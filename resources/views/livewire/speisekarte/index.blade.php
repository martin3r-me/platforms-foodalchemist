            ...
            <div class="{{ $card }} p-4 mt-4 space-y-3" data-sk-praesentation>
                ...
                @if($presentationLink)
                    <div class="rounded-lg bg-gray-50 border border-gray-200 p-3 text-xs" x-data>
                        <div class="flex items-center gap-2">
                            <div class="flex-1 rounded px-2 py-1 font-mono text-[11px] break-all select-all" style="background:#ffffff;color:#111827;border:1px solid #d1d5db;" data-sk-praes-link>{{ $presentationLink }}</div>
