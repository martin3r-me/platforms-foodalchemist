                ...
                <x-foodalchemist::modal-section title="Netz">
                    ...
                    @else
                        <div wire:ignore
                            ...
                            {{-- Legende: wie hängen die (lila) Anker zusammen (Foodpairing-Stil) --}}
                            <div class="flex flex-wrap items-center gap-x-4 gap-y-1 mt-2 text-[10px] text-slate-400">
                                <span class="text-slate-500">Anker-Verbindung:</span>
                                <span class="inline-flex items-center gap-1"><svg width="22" height="6"><line x1="0" y1="3" x2="22" y2="3" stroke="#a78bfa" stroke-width="3.4"/></svg> über gemeinsame Partner (dicker = mehr)</span>
                                <span class="inline-flex items-center gap-1"><svg width="22" height="6"><line x1="0" y1="3" x2="22" y2="3" stroke="#fcd34d" stroke-width="3"/></svg> direkt ★★★ Best</span>
                                <span class="inline-flex items-center gap-1"><svg width="22" height="6"><line x1="0" y1="3" x2="22" y2="3" stroke="#f59e0b" stroke-width="2" stroke-dasharray="5 3"/></svg> direkt ★★ Good</span>
                                <span class="text-slate-500">· Hover zeigt die geteilten Partner</span>
                            </div>
                        </div>
                    @endif
                </x-foodalchemist::modal-section>
